        ...
        <section className="bg-[#c3c6c7] mt-36">
            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-between px-6 py-20">
                ...
                <div className="max-w-xl text-center lg:text-left">
                    ...
                    <p className="text-gray-600 mb-6">
                        From electricians to cooks, we simplify your search for verified, reliable service providers — all in one place.
                        Whether it’s for daily help or special occasions, get connected with the right professionals with just a few clicks.
                    </p>
            ...
            <div className="bg-white py-28 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-center">
                    <div>
                        <img src={easyuse} alt="Easy" className="mx-auto mb-4 w-20 h-20 rounded-full object-cover" />
                    ...
                    <div>
                        <img src={easypay} alt="Store" className="mx-auto mb-4 w-20 h-20 rounded-full object-cover" />
